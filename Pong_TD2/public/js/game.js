var game = {
  ...
  movePlayers : function(posY, player) {
    ...
    if (player == undefined) {
      ...
      if ( game.control.controlSystem == "KEYBOARD" ) {
         ...
         if ( this.playerOne.goUp && this.playerOne.posY > 0 ) {
          ...
          else if ( this.playerOne.goDown && this.playerOne.posY < game.groundHeight - this.playerOne.height) {
            this.playerOne.posY+=5;
         }
      ...
      player.posY = posY;
        ...
        if ( game.control2.controlSystem2 == "KEYBOARD" ) {
          ...
          if ( this.playerTwo.goUp && this.playerTwo.posY > 0 ) {
            ...
            else if ( this.playerTwo.goDown && this.playerTwo.posY < game.groundHeight - this.playerTwo.height) {
              this.playerTwo.posY+=5;
          }
        ...
        if ( game.control2.controlSystem2 == "MOUSE" ) {
                // mouse control
                if (this.playerTwo.goUp && this.playerTwo.posY > game.control2.mousePointer2){
                    
                  this.playerTwo.posY-=5;
                }
                else if (this.playerTwo.goDown && this.playerTwo.posY < game.control2.mousePointer2 && this.playerTwo.posY < game.groundHeight - this.playerTwo.height){
