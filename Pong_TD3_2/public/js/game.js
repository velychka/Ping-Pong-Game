var game = {
  ...
  init : function(player) {
    ...
    if(player==3){
      ...
      this.initKeyboard(game.control3.onKeyDown3, game.control3.onKeyUp3);
      this.initMouse(game.control3.onMouseMove3);
    }
    if(player==4){
      this.initKeyboard(game.control4.onKeyDown4, game.control4.onKeyUp4);
      this.initMouse(game.control4.onMouseMove4);
    }
  ...
  movePlayers : function(posY, player, posY2, player2, posY3, player3) {
    ...
    if (player == 1) {
      ...
      if ( game.control.controlSystem == "MOUSE" ) {
        ...
        else if (this.playerOne.goDown && this.playerOne.posY < game.control.mousePointer && this.playerOne.posY < game.groundHeight/2.5){
          this.playerOne.posY+=5;
        }
      }
    }    
    ...
    if (player == 2) {
      ...
      if ( game.control2.controlSystem2 == "MOUSE" ) {
        // mouse control
        if (this.playerTwo.goUp && this.playerTwo.posY > 0){
            
          this.playerTwo.posY-=5;
        }
        else if (this.playerTwo.goDown && this.playerTwo.posY < game.control2.mousePointer2 && this.playerTwo.posY < game.groundHeight/2.5){
    ...
    if (player == 3) {
      ...
      player3 = this.playerTwo;
      player3.posY = posY3;


      if ( game.control3.controlSystem3 == "KEYBOARD" ) {
          // keyboard control
      ...
      if ( game.control3.controlSystem3 == "MOUSE" ) {
        // mouse control
        if (this.playerThree.goUp && this.playerThree.posY > (game.groundHeight)/2){        
          this.playerThree.posY-=5;
        }
        else if (this.playerThree.goDown && this.playerThree.posY < game.control3.mousePointer3 && this.playerThree.posY < game.groundHeight - this.playerThree.height){
          this.playerThree.posY+=5;
        }
      }
    ...
    if (player == 4) {
      ...
      if ( game.control4.controlSystem4 == "KEYBOARD" ) {
          // keyboard control
      ...
      if ( game.control4.controlSystem4 == "MOUSE" ) {
        // mouse control
        if (this.playerFour.goUp && this.playerFour.posY > (game.groundHeight)/2){        
          this.playerFour.posY-=5;
        }
        else if (this.playerFour.goDown && this.playerFour.posY < game.control4.mousePointer4 && this.playerFour.posY < game.groundHeight - this.playerFour.height){
          this.playerFour.posY+=5;
        }
      }
